...
set arrow 1 from 14310,-37.6 to 14390,-37.6 lw 1 nohead
set label 1 '-38 mV' at 14370,-50
...
# set origin 0.4245,0.05
# set size 0.2356,0.27
# set xrange [14150:14700]
# set yrange [0:8]

# set arrow 2 from t0,3.2 to t0,2 filled size screen 0.01,20 lw 1 lc 8
