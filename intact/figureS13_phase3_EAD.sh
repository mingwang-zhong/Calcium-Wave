...
set output "EAD3_CaMediated.pdf"
set multiplot 
...
path11 = "DAD/Hill6_alpha0.2_beta0.004_cstar2/wholecell.txt"
path12 = "DAD/Hill6_alpha0.2_beta0.004_cstar0.8/wholecell.txt"
path13 = "DAD/Hill6_alpha0.2_beta0.004_cstar0.8_clamp_cp_fast/wholecell.txt"

path21 = "DAD/Hill6_alpha0.2_beta0.004_cstar2/linescan.txt"
path22 = "DAD/Hill6_alpha0.2_beta0.004_cstar0.8/linescan.txt"
path23 = "DAD/Hill6_alpha0.2_beta0.004_cstar0.8_clamp_cp_fast/linescan.txt"
...
plot     path12 u ($1/1000-16.1):x every 4 w l lw 1 lc 2 t ""
...
set arrow 1 from 0.382,-58 to 0.382,-35 as 1
set arrow 2 from 0.15,-39 to 0.74,-39 nohead lw 0.5 dt 2 
set label 2 '-39 mV' at 0.75,-39
set key spacing 1.5 right at 1.5,60

x=7

plot     path11 u ($1/1000-16.1):x every 4 w l lw 1 lc 1 t "",\
        path12 u ($1/1000-16.1):x every 4 w l lw 1 lc 2 t "",\
        path13 u ($1/1000-16.1):x every 4 w l lw 1 lc 4 t ""
...
set arrow 1 from 0.382,400 to 0.382,506 as 1
...
plot     path21 u ($1/1000-16.1):2:3 every :4 w image t ""
...
plot     path22 u ($1/1000-16.1):2:3 every :4 w image t ""
...
set cbrange [0:2]
set cblabel "c_i (μM)" rotate by 90 offset -7
set arrow 1 from 0.382,-12 to 0.382,0 as 1

x=2

plot     path23 u ($1/1000-16.1):2:3 every :4 w image t ""
...
set key spacing 1.5 right at 1.5,5
set arrow 1 from 0.382,1.2 to 0.382,0.61 as 1

x=2

plot     path11 u ($1/1000-16.1):x every 4 w l lw 1 lc 1 t "c* = 2 μM",\
        path12 u ($1/1000-16.1):x every 4 w l lw 1 lc 2 t "c* = 0.8 μM",\
        path13 u ($1/1000-16.1):x every 4 w l lw 1 lc 4 t "[Ca^{2+}]_p clamped, c* = 0.8 μM"
...
set yrange [0:70]
set ytics nomirror 20 offset 0.6
set ytics add('  0'0)
set mytics 2
set ylabel "[Ca^{2+}]_p (μM)" offset 1.2
set key spacing 1.5
set arrow 1 from 0.382,11 to 0.382,2.6 as 1
set object 2 rect from 0.1,0 to 0.8,5 fc rgb "#F0F0F0" fs solid 0 border rgb "grey50" back lw 0.5
set arrow 2 from 0.8,5 to 0.89,14 filled size screen 0.01,15 lc 9 lw 0.5
...
set ytics add('  0'0)
set arrow 1 from 0.382,-3.5 to 0.382,-2 as 1
...
set arrow 4 from 0,-2.6 to 0.2,-2.6 as 7
set label 4 "0.2 s" at 0.03,-2.9 rotate by 0
set arrow 1 from 0.382,-1.9 to 0.382,-1.4 as 1
...
set arrow 1 from -10,-1.5 to -20,-2 as 1 lc 9
# set arrow 2 from -40,-1.3 to -27,-0.9 as 1 lc 9

plot     path11 u 7:( ($1>16102&&$1<17000)?$8:1/0 ) every 4 w l lw 1 lc 1 t "",\
        path12 u 7:( ($1>16102&&$1<17000)?$8:1/0 ) every 4 w l lw 1 lc 2 t "",\
        path13 u 7:( ($1>16102&&$1<17000)?$8:1/0 ) every 4 w l lw 1 lc 4 t ""
...
set arrow 1 from 0.382,3.3 to 0.382,2.6 as 1

plot    path11 u ($1/1000-16.1):3 w l lw 1 lc 1 t "",\
        path12 u ($1/1000-16.1):3 w l lw 1 lc 2 t "",\
        path13 u ($1/1000-16.1):3 w l lw 1 lc 4 t ""
